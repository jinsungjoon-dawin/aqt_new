<script>
    ...
    async function fetchItems() {
        ...
        items = allItems.filter((item) => {
            ...
            const matchKeyword =
                searchKeyword === "" || item.field_name.includes(searchKeyword);
            ...
            <tbody class="bg-white">
                {#each items as item, index (item.id)}
                    ...
                    >
                        ...
                        <td
                            class="border border-gray-300 px-2 py-1 text-center text-gray-900 bg-gray-50"
                            on:click|stopPropagation
                        >
